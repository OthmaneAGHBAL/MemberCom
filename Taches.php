...
<body>
    ...
    <div class="d-flex flex-column">
      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          ...
          <li><a href="Taches.php" class="nav-link scrollto active"><i class="fa-solid fa-list-check"></i><span>Taches</span></a></li>
        </ul>
      </nav><!-- .nav-menu -->
    </div>
  </header><!-- End Header -->
  ...
  <main id="main">
    ...
    <main class="page">
    <section class="inner-page h-100 ">
    <?php
      if($row['state'] == "admin"){
        include_once "php/AjouterTache.php";
      }
    ?>
    <div class="row text-center" id="Taches">
    </div>
  ...
  <script src="javascript/Taches.js"></script>
  <script src="javascript/Affecter.js"></script>
  <script src="javascript/main.js"></script>
