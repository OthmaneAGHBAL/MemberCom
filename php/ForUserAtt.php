<?php
    ...
    if(mysqli_num_rows($query) == 0){
        ...
        $output .="<tr>
            ...
            <td>
                <button type=\"button\" class=\"btn text-light bg-success btn-rounded mx-2\" onClick=\"YesOrNo({$row['unique_id']},'yes')\">
                    Yes
                </button>
                <button type=\"button\"  class=\"btn text-light bg-danger btn-rounded\" onClick=\"YesOrNo({$row['unique_id']},'no')\">
                    No
                </button>
            </td>
            </tr>";
